...
export default function LoadingPhase() {
  ...
  return (
    <div className="max-w-md mx-auto space-y-10 py-12">
        ...
        {stages.map((stage, index) => {
          ...
          return (
            <motion.div
              ...
              className="flex items-center justify-between p-4 rounded-xl bg-[#242424] border border-[#3a3a3a]"
            >
              <div className="flex items-center gap-4">
                {isCompleted ? (
                  ...
                  <Circle className="w-6 h-6 text-[#3a3a3a]" />
                )}
                <span
                  className={
                    isCompleted
      ...
      <div className="w-full bg-[#3a3a3a] h-1 rounded-full overflow-hidden">
        <motion.div
