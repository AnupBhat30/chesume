...
export const analyzeResumeQuick = async (resumeText, apiKey) => {
...
export const generateQuestions = async (resumeText, jobDescription = '', apiKey) => {
  const model = getModel(apiKey);
...
export const generateAnswer = async (questionText, questionType = 'technical', apiKey) => {
  const model = getModel(apiKey);
